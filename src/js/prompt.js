...
const nonHumanCharacter = [...sonic, ...animalCrossing, ...animeNonHuman, ...miscAnimal, ...kaiju, ...spongebob, ...drawfeeFictionalAnimal, ...nintendoAnimal, ...disneyAnimal];
