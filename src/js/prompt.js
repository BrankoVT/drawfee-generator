...
const nonPluralSweet = ["chocolate", "candy", "chips/crisps"];
...
const nonPluralMeal = ["spaghetti", "lasagne", "bread", "pizza", "beef", "pork", "fries/chips", "fish 'n' chips"];
...
const nonHumanCharacter = [...sonic, ...animeNonHuman, ...miscAnimal, ...kaiju, ...spongebob, ...drawfeeFictionalAnimal, ...nintendoAnimal, ...disneyAnimal];
const nonPluralFood = [...nonPluralSweet, ...nonPluralMeal, ...vegetableNoPlural];
