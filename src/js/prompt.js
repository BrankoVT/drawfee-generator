...
const detective = ["Colombo", "Sherlock Holmes", "Inspector Gadget", "Benoit Blanc"]
...
const humanCharacter = [...nintendo, ...pixarHuman, ...scoobyDoo, ...detective, ...hannaBarberaHuman, ...dreamworks, ...disneyHuman, ...drawfeeHumanCharacter, ...starTrek, ...animeHuman, ...miscHuman, ...familyGuy, ...aceAttorney, ...superHero, ...superVillain, ...simpsons, ...drawtectives, ...breakingBad];
